...
$(document).ready(async function() {
    if (!$("body").hasClass("permanent-loader")){
        if (isMobile.any()) {
            $("#site").prepend('<img class="showcase" style="object-fit:cover; object-position:60%; height: 100vh; width: 100vw" alt="Nivia" title="Nivia" src="resources/images/background.png">');
            finishLoad()
        } else {
